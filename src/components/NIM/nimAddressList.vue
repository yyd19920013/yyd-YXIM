        ...
        <div class="content scrollContainer">
            <ul class="addressList">
                <li class="notice">
                    ...
                    <div class="main">
                        <ul>
                            <li v-if="item.type=='applyFriend'&&item.state=='init'&&!item.read" v-for="(item,index) in sysMsgsList">
                                <div class="left">
                                    <h3>{{item.from}}</h3>
                        ...
                        <ul>
                            <li v-if="item.type=='teamInvite'&&item.state=='init'&&!item.read" v-for="(item,index) in sysMsgsList">
                                <div class="left">
                                    <h3>{{item.from}}</h3>
                                    <h4 class="overflow">{{item.ps}}</h4>
                                </div>
                ...
                <li class="friend">
                    ...
                    <div class="main">
                        <ul>
                            <li v-for="(item,index) in resultFriendsList">
                ...
                <li>
                    ...
                    <div class="main">
                        <ul>
                            <li v-for="(item,index) in teamsList" @click="toChat('team',item.teamId)">
                                {{item.name}}
                            </li>
                        </ul>
                    </div>
